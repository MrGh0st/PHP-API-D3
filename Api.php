...
class Diablo3API
{
    ...
    /**
     * Save user battletag to private $battletag of class
    ...
    /**
     * Download and decode (json) player profile, then save it to $profile
     * @return boolean
     */
    ...
    /**
     * Download and decode (json) hero profile, then save it to $hero
    ...
    /**
     * Download and decode (json) item, then save it to $item
     * @param $item string
     * @return boolean
     */
    ...
    /**
     * Download and decode (json) follower, then save it to $follower
    ...
    /**
     * Download and decode (json) artisan, then save it to $artisan,
    ...
    /**
     * Using cURL to get content or false if failed.
     * @param string $url
    ...
    /**
     * Return information about profile on battlenet.
     * @return Array
     */
    ...
    /**
     * Return information about hero on battlenet.
     * @return Array
     */
    ...
    /**
     * Return information about followers of your hero on battlenet.
     * @return Array
     */
    ...
    /**
     * Return information about item on battlenet.
     * @return Array
     */
    ...
    /**
     * Return information about artisan on battlenet.
     * @return Array
     */
